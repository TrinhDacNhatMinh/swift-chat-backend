...
export class AuthController {
  ...
  @ApiResponse({
    status: 400,
    description: 'Bad Request (e.g. Email/Username already in use)',
  })
  ...
  @ApiResponse({
    status: 400,
    description:
      'Bad Request (Invalid Google payload or already registered via local)',
  })
  @ApiResponse({
    status: 401,
  ...
  @ApiResponse({
    status: 400,
    description: 'Bad Request (Invalid token or already logged out)',
  })
