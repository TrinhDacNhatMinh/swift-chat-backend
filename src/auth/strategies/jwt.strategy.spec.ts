...
describe('JwtStrategy', () => {
  ...
  it('should return account payload when account exists in validate()', async () => {
  ...
  it('should throw UnauthorizedException when account does not exist in validate()', async () => {
